...
export default function Footer() {
  return (
    <footer className="bg-black border-t border-purple-500/20 text-white font-sans overflow-hidden">
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 md:grid-cols-5 gap-10">
        ...
        <div className="md:col-span-2">
          ...
          <div className="flex space-x-4 text-white/60 mb-6">
            ...
            <a href="https://www.facebook.com/cohortsapp" className="hover:text-white transition-colors">
      ...
      {/* Bottom Bar */}
      <div className="border-t border-gray-800 px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row justify-between items-center text-sm text-white/70">
        <p className="text-center md:text-left">
          © 2025 – OYM LABS PRIVATE LIMITED, ALL RIGHTS RESERVED.
        </p>
        <div className="flex space-x-4 mt-4 md:mt-0">
          <a href="/terms" className="hover:text-white">Terms & Conditions</a>
          <a href="/policies" className="hover:text-white">Privacy Policy</a>
        </div>
      </div>
    </footer>
  );
